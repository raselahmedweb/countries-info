...
CountryInfos.forEach((singleCountry, indexNumber)=> {

    let mkCountryNum = ++indexNumber;

    if(mkCountryNum < 10){
        mkCountryNum = `00${++indexNumber}`;
    }else if(mkCountryNum < 100 && mkCountryNum >= 10){
        mkCountryNum = `0${++indexNumber}`;
    }
    ...
    ${mkCountryNum}
            ...
            <div class="countrycontent">
                <div class="countryInfo">
                    <span>Country Name: </span> <b>${CountryInfos[indexNumber].name}</b>
                </div>
            </div>
            <div class="countrycontent">
                <div class="countryInfo">
                    <span>Country Region:</span> <b>${CountryInfos[indexNumber].region}</b>
                </div>
            </div>
            <div class="countrycontent">
                <div class="countryInfo">
                    <span>Country ISO:</span> <b>${CountryInfos[indexNumber].iso["alpha-3"]}</b>
                </div>
            </div>
            <div class="countrycontent">
                <div class="countryInfo">
                    <span>Dial Code:</span> <b>${CountryInfos[indexNumber].phone}</b>
                </div>
            </div>
            <div class="countrycontent">
                <div class="countryInfo">
                    <span>Image Flag:</span>
                    <img width="30" src="${CountryInfos[indexNumber].image}" alt="">
                </div>
            </div>
        </div>`;
})